                              ...
                              RichText(
                                ...
                                text: TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                        text:
                                            'See your tailored list of candidates in the podium, "'),
                                    TextSpan(
                                        text: 'Swipe Right',
                                        style: TextStyle(
                                    ...
                                    TextSpan(
                                        text:
                                            '" to save them to your ballot. Take a deep dive into candidate profiles, view your voting info, and bring up your civic score through polls.'),
                                  ],
                                ),
                              ),
                            ],
