...
class _VoterInfo2State extends State<VoterInfo2> {
  ...
  void radioButtonSelected(int tileIndex, String selection, bool status) {
    ...
    if (widget.answers.partyVoting != "" &&
        widget.answers.politicalAffiliation != "") {
      _nextButtonColor = const Color(0xFFF3D433);
    }
    setState(() {});
  }
                      ...
                      children: [
                        ...
                        RadioListTile(
                            visualDensity: const VisualDensity(
                                horizontal: -4, vertical: -4),
                            title:
                                Text('Republican', style: optionsTextStyle()),
                            activeColor: Colors.black,
                            value: "Republican",
                        ...
                        RadioListTile(
                            visualDensity: const VisualDensity(
                                horizontal: -4, vertical: -4),
                            title:
                                Text('Democratic', style: optionsTextStyle()),
                            activeColor: Colors.black,
                            value: "Democratic",
                            groupValue: widget.answers.politicalAffiliation,
                            onChanged: (String? s) {
                        ...
                        RadioListTile(
                            visualDensity: const VisualDensity(
                                horizontal: -4, vertical: -4),
                            title:
                                Text('Libertarian', style: optionsTextStyle()),
                            activeColor: Colors.black,
                            value: "Libertarian",
                            groupValue: widget.answers.politicalAffiliation,
                            onChanged: (String? s) {
                        ...
                        RadioListTile(
                            visualDensity: const VisualDensity(
                                horizontal: -4, vertical: -4),
                            title:
                                Text('Independent', style: optionsTextStyle()),
                            activeColor: Colors.black,
                            value: "Independent",
                            groupValue: widget.answers.politicalAffiliation,
                            onChanged: (String? s) {
