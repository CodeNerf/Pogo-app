...
class HamburgerMenuFunctions {
  // This is a function to register to vote, which takes a two-letter state abbreviation as input to take the user for to their specific states webpage
  static void registerToVote(String stateInitial) {
    String url = '';
    switch (stateInitial) {
      case 'AL':
        launchUrl(Uri.parse(
            'https://www.alabamainteractive.org/sos/voter_registration/instructions.action;wsuid=FBA8B8BE9DEDA1EFECF00BC8B12A3A45'));
        break;
      case 'AK':
        launchUrl(Uri.parse(
      ...
      case 'CT':
        launchUrl(
            Uri.parse('https://voterregistration.ct.gov/OLVR/welcome.do'));
        break;
      case 'DE':
      ...
      case 'GA':
        launchUrl(Uri.parse(
            'https://mvp.sos.ga.gov/s/voter-registration?IsRegisterNow=true#no-back-button'));
        break;
      case 'HI':
      ...
      case 'KS':
        launchUrl(
            Uri.parse('https://www.kdor.ks.gov/Apps/VoterReg/Default.aspx'));
        break;
      case 'KY':
      ...
      case 'MO':
        launchUrl(Uri.parse(
            'https://s1.sos.mo.gov/elections/goVoteMissouri/register.aspx'));
        break;
      case 'MT':
      ...
      case 'NE':
        launchUrl(
            Uri.parse('https://www.nebraska.gov/apps-sos-voter-registration/'));
        break;
      case 'NV':
        launchUrl(Uri.parse(
            'https://www.nvsos.gov/sosvoterservices/Registration/step1.aspx'));
        break;
      case 'NH':
        launchUrl(Uri.parse(
            'https://www.sos.nh.gov/elections/voters/register-to-vote/'));
        break;
      case 'NJ':
      ...
      case 'OR':
        launchUrl(
            Uri.parse('https://sos.oregon.gov/voting/Pages/registration.aspx'));
        break;
      case 'PA':
        launchUrl(Uri.parse(
      ...
      case 'TN':
        launchUrl(
            Uri.parse('https://sos.tn.gov/products/elections/absentee-voting'));
        break;
      case 'TX':
      ...
      case 'WY':
        launchUrl(
            Uri.parse('https://sos.wyo.gov/Elections/RegisteringtoVote.aspx'));
        break;
    }
    // The function launches a URL for the corresponding state
    launchUrl(Uri.parse(url));
  }

  // This is a function to request an absentee ballot, which takes a two-letter state abbreviation as input to take the user for to their specific states webpage
  static void requestAbsenteeBallot(String stateInitial) {
    ...
    switch (stateInitial) {
      ...
      case 'AZ':
        launchUrl(
            Uri.parse('https://my.arizona.vote/Early/ApplicationLogin.aspx'));
        break;
      case 'AR':
        launchUrl(Uri.parse(
      ...
      case 'HI':
        launchUrl(
            Uri.parse('https://elections.hawaii.gov/voting/absentee-voting/'));
        break;
      case 'ID':
        launchUrl(Uri.parse(
      ...
      case 'KS':
        launchUrl(
            Uri.parse('https://sos.ks.gov/elections/voter-information.html'));
        break;
      case 'KY':
        launchUrl(Uri.parse(
      ...
      case 'MD':
        launchUrl(
            Uri.parse('https://elections.maryland.gov/voting/absentee.html'));
        break;
      case 'MA':
        launchUrl(Uri.parse(
      ...
      case 'MS':
        launchUrl(
            Uri.parse('https://www.sos.ms.gov/absentee-voting-information'));
        break;
      case 'MO':
        launchUrl(Uri.parse(
      ...
      case 'NY':
        launchUrl(
            Uri.parse('https://www.elections.ny.gov/VotingAbsentee.html'));
        break;
      case 'NC':
        launchUrl(
            Uri.parse('https://votebymail.ncsbe.gov/app/absentee/lookup'));
        break;
      case 'ND':
      ...
      case 'OR':
        launchUrl(
            Uri.parse('https://sos.oregon.gov/elections/documents/sel111.pdf'));
        break;
      case 'PA':
        launchUrl(Uri.parse(
      ...
      case 'TN':
        launchUrl(
            Uri.parse('https://sos.tn.gov/elections/services/absentee-voting'));
        break;
      case 'TX':
        launchUrl(Uri.parse(
      ...
      case 'VA':
        launchUrl(
            Uri.parse('https://www.elections.virginia.gov/citizen-portal/'));
        break;
      case 'WA':
      ...
      case 'WI':
        launchUrl(
            Uri.parse('https://myvote.wi.gov/en-us/Vote-Absentee-By-Mail'));
        break;
      case 'WY':
        launchUrl(Uri.parse(
  ...
  // This is a function to request to vote by mail, which takes a two-letter state abbreviation as input to take the user for to their specific states webpage
  static void voteByMail(String stateInitial) {
    ...
    switch (stateInitial) {
      ...
      case 'NJ':
        launchUrl(
            Uri.parse('https://www.nj.gov/state/elections/vote-by-mail.shtml'));
        break;
      case 'NM':
        launchUrl(Uri.parse(
            'https://portal.sos.state.nm.us/OVR/WebPages/AbsenteeApplication.aspx'));
      ...
      case 'OR':
        launchUrl(Uri.parse(
            'https://sos.oregon.gov/voting/Pages/Mail-in-Voting.aspx'));
        break;
      case 'PA':
        launchUrl(Uri.parse(
      ...
      case 'RI':
        launchUrl(Uri.parse(
            'https://vote.sos.ri.gov/Home/UpdateVoterRecord?ActiveFlag=2'));
        break;
      case 'SC':
      ...
      case 'WA':
        launchUrl(Uri.parse(
            'https://www.sos.wa.gov/elections/voters/mail-ballot-voting.aspx'));
        break;
      case 'WV':
        launchUrl(Uri.parse(
  ...
  // This is a function to update registration, which takes a two-letter state abbreviation as input to take the user for to their specific states webpage
  static void updateRegistration(String stateInitial) {
    ...
    switch (stateInitial) {
      ...
      case 'DE':
        launchUrl(Uri.parse(
            'https://elections.delaware.gov/voter/voteabsentee.shtml'));
        break;
      case 'FL':
        launchUrl(Uri.parse('https://registertovoteflorida.gov/home'));
        break;
      ...
      case 'ID':
        launchUrl(
            Uri.parse('https://idahovotes.gov/online-voter-registration/'));
        break;
      case 'IL':
      ...
      case 'NC':
        launchUrl(Uri.parse(
            'https://www.ncsbe.gov/registering/how-register/register-person-same-day-registration'));
        break;
      case 'ND':
        launchUrl(Uri.parse('https://vip.sos.nd.gov/PortalList.aspx'));
        break;
